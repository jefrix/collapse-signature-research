...
Status: initial repository scaffold created on May 7, 2026, with first source documents copied into their working folders.
...
The repository currently contains the folder scaffold plus copies of the initial source documents:

- `methodology/deep-research-report.md`: Stream Three method memo.
- `cases/late-tang/Late Tang case.docx`: Late Tang case brief.
- `tools/CollapseSignature_Foundation.docx`: project foundation and multi-agent onboarding document.

Next likely additions are:

- Initial case brief templates under the remaining `cases/` subfolders.
- Stream onboarding notes or ledgers in `streams/`.
- A first weekly synthesis document in `synthesis/`.
