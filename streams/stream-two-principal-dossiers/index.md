# Stream Two: Principal Dossiers Index

**Purpose:** Organization hub for tracking individual technocratic-class principals as distinct entities (separate from their corporate vehicles). This supports ideological signaling, network analysis, political positioning, and personal capital deployment monitoring.
...
## Capital Allocators
These principals primarily allocate large-scale capital across AI, infrastructure, and technology.
...
## Frontier Builders
Founders and leaders building core AI capabilities, models, and frontier infrastructure.
...
- [README.md](./README.md) — Overview of Stream Two approach and methodology
- [Dossier-Template.md](./Dossier-Template.md) — Master template (duplicated into each principal folder)
- [00-taxonomy.md](./00-taxonomy.md) — v3 taxonomy and schema reference
